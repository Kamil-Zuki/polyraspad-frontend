      ...
      >
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0 z-10">
          <button
            ...
            className="px-2.5 py-1.5 text-white hover:text-brand-purple transition-all bg-app-bg hover:bg-dark-700 rounded-md border border-white/20 hover:border-brand-purple/50 shadow-sm text-sm font-bold"
          ...
          <button
            ...
            className="px-2.5 py-1.5 text-white hover:text-blue-400 transition-all bg-app-bg hover:bg-dark-700 rounded-md border border-white/20 hover:border-blue-400/50 shadow-sm text-sm font-bold"
            title="Edit deck"
          >
            ✎
          </button>
          <button
            ...
            className="px-2.5 py-1.5 text-white hover:text-red-400 transition-all bg-app-bg hover:bg-dark-700 rounded-md border border-white/20 hover:border-red-400/50 shadow-sm text-sm font-bold"
            title="Delete deck"
          >
            ×
          </button>
