            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div
                  ...
                  className="rounded-xl border border-dashed border-white/15 bg-app-bg px-4 py-4 text-sm text-gray-300 focus:outline-none focus:ring-2 focus:ring-brand-primary/50"
                >
                  <p className="font-medium text-white">Paste cover from clipboard</p>
                  <p className="mt-1 text-xs text-gray-400">
                    Click here and press <kbd className="rounded bg-white/10 px-1.5 py-0.5 text-[11px]">Ctrl+V</kbd> / <kbd className="rounded bg-white/10 px-1.5 py-0.5 text-[11px]">Cmd+V</kbd>
                  </p>
                  {coverImageUrl && (
                    <p className="mt-3 truncate text-xs text-emerald-300">Cover image ready</p>
                  )}
                </div>
                <input
                ...
                <div className="mt-3 flex items-center gap-3">
                  <button
                    ...
                    className="px-3 py-2 rounded-lg bg-white/5 text-gray-300 hover:bg-white/10 transition-colors text-sm font-medium"
                  >
                    Choose from device
                  </button>
                  <button
                    ...
                    className="px-3 py-2 rounded-lg bg-brand-primary/20 text-brand-primary hover:bg-brand-primary/30 transition-colors text-sm font-medium"
                  >
