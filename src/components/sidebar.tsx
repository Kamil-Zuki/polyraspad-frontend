...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 h-full bg-app-surface border-r border-app-border flex flex-col flex-shrink-0 z-20">
      {/* Logo Area */}
      <div className="h-16 flex items-center px-5 border-b border-app-border">
        <div className="w-7 h-7 rounded bg-gradient-to-br from-brand-primary to-brand-secondary flex items-center justify-center text-white font-bold text-sm mr-3 shadow-glow">
          P
        </div>
      ...
      <div className="p-4 pb-2">
        <button className="w-full bg-app-bg hover:bg-app-hover transition-colors rounded-xl p-3 flex items-center justify-between border border-app-border group">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-indigo-900/40 flex items-center justify-center text-xl border border-white/5">
              📚
            </div>
            <div className="text-left">
              <div className="text-xs text-gray-500 font-bold group-hover:text-brand-primary transition uppercase tracking-wider">
                Current Project
              </div>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-2 space-y-6 custom-scroll">
        {/* Streak Widget */}
        <div className="bg-gradient-to-r from-brand-primary/10 to-brand-secondary/10 border border-brand-primary/20 rounded-xl p-3 mx-1 relative overflow-hidden group">
        ...
        <div className="mt-4 pt-4 border-t border-app-border">
          <Link
            href="/creator"
            className="nav-item flex items-center gap-3 px-3 py-2 rounded-lg text-gray-300 bg-white/5 hover:bg-white/10 transition-all border border-app-border"
          >
      ...
      <div className="p-4 border-t border-app-border bg-app-surface/50 backdrop-blur-sm">
        ...
        >
          <div className="relative">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-brand-primary to-brand-secondary flex items-center justify-center text-white font-bold text-sm border border-gray-600 group-hover:border-brand-primary transition">
              {userInitial}
            </div>
            <div className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-status-success border-2 border-app-surface rounded-full" />
          </div>
          <div className="flex-1 min-w-0">
            <div className="text-sm font-medium text-white truncate group-hover:text-brand-primary transition">
