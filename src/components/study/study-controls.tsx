...
export function StudyControls({
  ...
  if (!isRevealed) {
    return (
      <footer className="min-h-28 flex flex-col items-center justify-center py-4 sm:py-6 z-20">
        <button 
          onClick={onReveal}
          disabled={disabled}
  ...
  return (
    <footer className="min-h-28 flex flex-col items-center justify-center py-3 sm:py-4 z-20">
      {/* SRS Actions — 2×2 on phones to avoid horizontal scroll */}
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 w-full max-w-2xl px-2 sm:px-4">
        ...
        >
          <span className="text-xs font-bold text-gray-500 uppercase mb-1 group-hover:text-status-again transition">{t("again")}</span>
        ...
        >
          <span className="text-xs font-bold text-gray-500 uppercase mb-1 group-hover:text-status-hard transition">{t("hard")}</span>
        ...
        >
          <span className="text-xs font-bold text-gray-500 uppercase mb-1 group-hover:text-status-good transition">{t("good")}</span>
        ...
        >
          <span className="text-xs font-bold text-gray-500 uppercase mb-1 group-hover:text-status-easy transition">{t("easy")}</span>
